...
import com.anyview.service.impl.SchoolServiceImpl;
...
/*      this.schemeService = schemeService;
   ...
   /* @ResponseBody
    ...
    public String logout(Long sid,Long role,String token){
        ChannelIdRel.removeByToken(token);
    ...
    public String getSchool(HttpServletRequest request){
        ...
        /*List<School> list = schoolServiceImpl.getSchools();*/
